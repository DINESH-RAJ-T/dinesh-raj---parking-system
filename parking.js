  ...
  if (pho.length !=10) {
    ...
    let remover=document.createElement('input'); //to a create a button that removes the row it resides in
        ...
        function createReceiptTable(){        
          ...
          //to get the date of parking receipt being issued
          ...
          ModalBody.innerHTML=`
          <center><h3><i class="fa fa-info-circle" aria-hidden="true"></i> TDR Parking Details </h3></center>
          <br>
          <p style="text-align:right;position:relative;">Date: ${receiptDate}<p>
          <br>
          <p><i class="bi bi-person"></i> Cus Name : &ensp;${Rcell0.innerHTML}</p>
          <p><i class="bi bi-telephone-forward"></i> Phone No	: &ensp;${Rcell1.innerHTML}</p>
          <p><i class="fa fa-list-alt" aria-hidden="true"></i> Plate No	:  &ensp;${Rcell2.innerHTML}<p>
          <p><i class="lni lni-car-alt"></i> Model	:  ${Rcell3.innerHTML}</p> 
          <p><i class="bi bi-clock"></i> Parking time :  &ensp;${minutesLapsed}</p>	
          <p><i class="bi bi-cash"></i> Parking cost :  &ensp;${totaldue}</p>
          <br>
          <center><p><i class="bi bi-emoji-smile"></i> Thank you for choosing TDR parking services, come again</p></center>
